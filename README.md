...
**ana_term** is a text-first terminal test harness that runs comparable VT-core, rendering, input, and performance probes across terminals and platforms, and emits machine-readable reports plus readable markdown summaries.
