...
- Active macro batch (`in_progress`): `PH1-M32` (`PH1-M32-S1`) — terminal launch semantics hardening (`ANA-3201`..`ANA-3210`)
- Super-gate (Architect review): `ANA-GATE-340`
...
4. `docs/todo/PH1_M32_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-3201`..`ANA-3210` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-340` or hard blocker.
