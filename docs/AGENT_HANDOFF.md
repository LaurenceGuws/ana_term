...
- Active macro batch (`in_progress`): `PH1-M15` (`PH1-M15-S1`) — execution-summary fingerprint integrity hardening (`ANA-1501`..`ANA-1510`)
- Super-gate (Architect review): `ANA-GATE-170`
...
4. `docs/todo/PH1_M15_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-1501`..`ANA-1510` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-170` or hard blocker.
