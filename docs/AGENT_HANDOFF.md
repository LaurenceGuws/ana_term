...
- Active macro batch (`review_gate`): `PH1-M30` (`PH1-M30-S1`) — state-envelope fingerprint hardening (`ANA-3001`..`ANA-3010`)
- Super-gate (Architect review): `ANA-GATE-320` (checkpoint: `docs/todo/PH1_M30_CHECKPOINT.md`)
...
4. `docs/todo/PH1_M30_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-3001`..`ANA-3010` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-320` or hard blocker.
