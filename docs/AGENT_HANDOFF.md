...
- Active macro batch (`in_progress`): `PH1-M25` (`PH1-M25-S1`) — provenance-envelope fingerprint integrity hardening (`ANA-2501`..`ANA-2510`)
- Super-gate (Architect review): `ANA-GATE-270`
...
4. `docs/todo/PH1_M25_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-2501`..`ANA-2510` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-270` or hard blocker.
