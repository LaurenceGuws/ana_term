...
- Active macro batch (`review_gate`): `PH1-M28` (`PH1-M28-S1`) — trace-envelope fingerprint hardening (`ANA-2801`..`ANA-2810`)
- Super-gate (Architect review): `ANA-GATE-300` (checkpoint: `docs/todo/PH1_M28_CHECKPOINT.md`)
...
4. `docs/todo/PH1_M28_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-2801`..`ANA-2810` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-300` or hard blocker.
