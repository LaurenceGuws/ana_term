...
- Active macro batch (`in_progress`): `PH1-M27` (`PH1-M27-S1`) — consistency-envelope fingerprint hardening (`ANA-2701`..`ANA-2710`)
- Super-gate (Architect review): `ANA-GATE-290`
...
4. `docs/todo/PH1_M27_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-2701`..`ANA-2710` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-290` or hard blocker.
