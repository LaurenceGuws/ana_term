...
- Active macro batch (`in_progress`): `PH1-M29` (`PH1-M29-S1`) — lineage-envelope fingerprint hardening (`ANA-2901`..`ANA-2910`)
- Super-gate (Architect review): `ANA-GATE-310`
...
4. `docs/todo/PH1_M29_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-2901`..`ANA-2910` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-310` or hard blocker.
