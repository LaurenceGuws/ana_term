...
- Active macro batch (`in_progress`): `PH1-M26` (`PH1-M26-S1`) — integrity-envelope fingerprint hardening (`ANA-2601`..`ANA-2610`)
- Super-gate (Architect review): `ANA-GATE-280`
...
4. `docs/todo/PH1_M26_TICKETS.md`
5. `docs/Vision.md`
6. `docs/WORKFLOW.md`

## Execution Contract

- Execute only `ANA-2601`..`ANA-2610` in order.
- One ticket per commit with `[ANA-###]` prefix.
- Stop at `ANA-GATE-280` or hard blocker.
