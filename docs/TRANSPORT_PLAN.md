...
This document bounds **terminal transport ownership seams** for `ana_term`: how runs record *which transport path* was used (`none` vs deterministic **`pty_stub`**) while staying **text-first**, **offline-safe**, and **compare-friendly**.
