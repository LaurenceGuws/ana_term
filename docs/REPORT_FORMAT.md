...
**Serialization order**: after `context_summary_fingerprint_version`, before root **`artifact_bundle_fingerprint_*`**, root **`report_envelope_fingerprint_*`**, root **`compare_envelope_fingerprint_*`**, and the nested `transport` object: `metadata_envelope_fingerprint_digest`, `metadata_envelope_fingerprint_version` (lexicographic).
...
**Serialization order**: after `metadata_envelope_fingerprint_version`, before root **`report_envelope_fingerprint_*`**, root **`compare_envelope_fingerprint_*`**, and the nested `transport` object: `artifact_bundle_fingerprint_digest`, `artifact_bundle_fingerprint_version` (lexicographic).
...
**Serialization order**: after `artifact_bundle_fingerprint_version`, before root **`compare_envelope_fingerprint_*`** and the nested `transport` object: `report_envelope_fingerprint_digest`, `report_envelope_fingerprint_version` (lexicographic).
...
**Serialization order**: after `report_envelope_fingerprint_version`, before the nested `transport` object: `compare_envelope_fingerprint_digest`, `compare_envelope_fingerprint_version` (lexicographic).
