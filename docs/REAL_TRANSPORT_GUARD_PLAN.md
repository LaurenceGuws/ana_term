...
This document defines guardrails for introducing **real** terminal transport (PTY / ConPTY and related I/O) into `ana_term` without weakening deterministic artifacts or safety defaults.
