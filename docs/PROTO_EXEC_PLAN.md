...
This document bounds **protocol-aware execution seams** for `ana_term`: how the harness records *how* specs were executed (placeholder vs protocol stub) while keeping **text-first, deterministic artifacts** suitable for `compare`.
