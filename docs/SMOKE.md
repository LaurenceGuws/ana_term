...
- Serialization order: immediately after **`context_summary_fingerprint_version`**, before the nested **`transport`** object (see **`docs/REPORT_FORMAT.md`**).
