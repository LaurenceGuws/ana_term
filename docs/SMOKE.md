# Smoke workflow (PH1-M2 through PH1-M21)
...
- Serialization order: immediately after **`compare_envelope_fingerprint_version`**, before the nested **`transport`** object (see **`docs/REPORT_FORMAT.md`**).
