...
This document bounds the first **real terminal comparison lane** for `ana_term`: same probe suite, multiple terminals on **one OS**, with comparable machine-readable and markdown outputs.
