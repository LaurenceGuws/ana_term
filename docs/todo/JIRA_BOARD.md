...
- `in_progress`: `ANA-110`
- `todo`: `ANA-111`..`ANA-120`
- `blocked`: none
- `review_gate`: none
- `done`: none
- `implementation_complete` (Engineer; Architect promotes to `done` at gate): `ANA-101`, `ANA-102`, `ANA-103`, `ANA-104`, `ANA-105`, `ANA-106`, `ANA-107`, `ANA-108`, `ANA-109`
