...
- Sprint ID: `PH1-M40-S1`
- Objective: launch diagnostics compatibility envelope (`ANA-4001`..`ANA-4010`)
- Commit budget before checkpoint: `10`
- Super-gate: `ANA-GATE-420`

## Ticket Order (`PH1-M40-S1`)
