...
- [ ] Execute `ANA-2801` through `ANA-2810` in order from `docs/todo/PH1_M28_TICKETS.md`.
- [ ] Keep Jira board status current in `docs/todo/JIRA_BOARD.md`.
- [ ] Stop only at `ANA-GATE-300` (post `ANA-2810`) unless truly blocked.
- [ ] Submit checkpoint packet in `docs/todo/PH1_M28_CHECKPOINT.md`.
