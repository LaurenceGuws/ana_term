...
- Sprint `PH1-M38-S1` engineer execution is **active** (tickets `ANA-3801`..`ANA-3810`).
- Super-gate: **`ANA-GATE-400`** — stop and report after checkpoint publication.
- Ticket source (reference): `docs/todo/PH1_M38_TICKETS.md`.
...
3. `docs/todo/PH1_M38_TICKETS.md`
...
- Execute tickets `ANA-3801` through `ANA-3810` in strict order.
...
- `ANA-GATE-400` reached (post `ANA-3810`), or
