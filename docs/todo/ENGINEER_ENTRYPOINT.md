...
- Execute only `PH1-M23` / sprint `PH1-M23-S1`.
- Super-gate: `ANA-GATE-250` (report after `ANA-2310` or hard blocker).
- Ticket source: `docs/todo/PH1_M23_TICKETS.md`.
...
3. `docs/todo/PH1_M23_TICKETS.md`
...
- Execute tickets `ANA-2301` through `ANA-2310` in strict order.
...
- `ANA-GATE-250` reached (post `ANA-2310`), or
