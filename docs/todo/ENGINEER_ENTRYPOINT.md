...
- Execute only `PH1-M26` / sprint `PH1-M26-S1`.
- Super-gate: `ANA-GATE-280` (report after `ANA-2610` or hard blocker).
- Ticket source: `docs/todo/PH1_M26_TICKETS.md`.
...
3. `docs/todo/PH1_M26_TICKETS.md`
...
- Execute tickets `ANA-2601` through `ANA-2610` in strict order.
...
- `ANA-GATE-280` reached (post `ANA-2610`), or
