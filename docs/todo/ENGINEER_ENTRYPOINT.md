...
- Execute only `PH1-M34` / sprint `PH1-M34-S1`.
- Super-gate: `ANA-GATE-360` (report after `ANA-3410` or hard blocker).
- Ticket source: `docs/todo/PH1_M34_TICKETS.md`.
...
3. `docs/todo/PH1_M34_TICKETS.md`
...
- Execute tickets `ANA-3401` through `ANA-3410` in strict order.
...
- `ANA-GATE-360` reached (post `ANA-3410`), or
