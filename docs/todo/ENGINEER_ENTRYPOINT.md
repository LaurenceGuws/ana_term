...
- Execute only `PH1-M25` / sprint `PH1-M25-S1`.
- Super-gate: `ANA-GATE-270` (report after `ANA-2510` or hard blocker).
- Ticket source: `docs/todo/PH1_M25_TICKETS.md`.
...
3. `docs/todo/PH1_M25_TICKETS.md`
...
- Execute tickets `ANA-2501` through `ANA-2510` in strict order.
...
- `ANA-GATE-270` reached (post `ANA-2510`), or
