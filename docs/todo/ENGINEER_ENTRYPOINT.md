...
- Execute only `PH1-M32` / sprint `PH1-M32-S1`.
- Super-gate: `ANA-GATE-340` (report after `ANA-3210` or hard blocker).
- Ticket source: `docs/todo/PH1_M32_TICKETS.md`.
...
3. `docs/todo/PH1_M32_TICKETS.md`
...
- Execute tickets `ANA-3201` through `ANA-3210` in strict order.
...
- `ANA-GATE-340` reached (post `ANA-3210`), or
